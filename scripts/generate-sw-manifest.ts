...
async function generateSwManifest() {
  ...
  // Explicit prefix list for JS codec wrappers and workers.
  // We filter JS files by prefix to precache only critical codec/worker bundles required for offline processing,
  // avoiding precaching 36+ PSEO page route chunks or UI modal chunks during SW installation.
