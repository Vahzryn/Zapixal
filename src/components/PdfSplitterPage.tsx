      ...
      <div className="bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-200/80 dark:border-zinc-800 shadow-xl overflow-hidden p-6 sm:p-8 space-y-6">
        ...
        {successResult ? (
          ...
          <div className="space-y-6">
            {/* File info header */}
            <div className="p-4 rounded-2xl bg-zinc-50 dark:bg-[#25282c] border border-zinc-200 dark:border-zinc-700 flex items-center justify-between gap-4">
              ...
              <button
                onClick={handleReset}
                className="px-3 py-1.5 rounded-xl text-xs font-semibold bg-zinc-200 dark:bg-zinc-700 text-zinc-700 dark:text-zinc-200 hover:bg-zinc-300 transition-colors shrink-0"
              >
                Change PDF
              </button>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-3 text-sm bg-zinc-50 dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 rounded-xl text-zinc-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500"
                />
                <button
                  disabled={isProcessing || !rangeInput.trim()}
                  onClick={handleSplit}
                  className="px-6 py-3 rounded-xl bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 text-white font-bold text-sm shadow-lg shadow-indigo-600/25 transition-all flex items-center gap-2 shrink-0 cursor-pointer"
                >
                  {isProcessing ? (
                    <>
