  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-8 py-2 sm:py-6 animate-in fade-in duration-300">
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm sm:text-base md:text-lg text-neutral-600 dark:text-neutral-400 font-medium leading-relaxed max-w-3xl">
          {article.description}
        </p>
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 py-3 border-y border-neutral-200 dark:border-neutral-800 text-xs text-neutral-600 dark:text-neutral-400 font-medium">
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
            <span 
              ...
              className="inline-flex items-center gap-1 font-bold text-blue-700 dark:text-blue-300 bg-blue-100/80 dark:bg-blue-950/80 px-2.5 py-0.5 rounded-full border border-blue-200 dark:border-blue-800/60 cursor-pointer hover:bg-blue-200 dark:hover:bg-blue-900 transition-colors"
            >
