  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-16 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-neutral-600 dark:text-[#9aa0a6] max-w-2xl mx-auto font-medium leading-relaxed">
          The ultra-fast, privacy-first image conversion engine that runs entirely inside your browser.
        </p>
      </div>

      <div className="grid md:grid-cols-2 gap-8 mb-16">
        <div className="bg-white dark:bg-[#202124] p-8 rounded-3xl border border-neutral-200 dark:border-[#3c4043] shadow-sm flex flex-col gap-4">
          <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-[#8ab4f8] rounded-xl flex items-center justify-center mb-2">
            <Cpu className="w-6 h-6" />
          </div>
          <h3 className="text-2xl font-bold text-neutral-900 dark:text-white">WebAssembly Powered</h3>
          <p className="text-neutral-600 dark:text-[#bdc1c6] leading-relaxed">
        ...
        <div className="bg-white dark:bg-[#202124] p-8 rounded-3xl border border-neutral-200 dark:border-[#3c4043] shadow-sm flex flex-col gap-4">
          <div className="w-12 h-12 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-[#81c995] rounded-xl flex items-center justify-center mb-2">
            <Shield className="w-6 h-6" />
          </div>
          <h3 className="text-2xl font-bold text-neutral-900 dark:text-white">Zero-Upload Privacy</h3>
          <p className="text-neutral-600 dark:text-[#bdc1c6] leading-relaxed">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6 text-neutral-600 dark:text-[#bdc1c6] leading-relaxed">
        <h2 className="text-3xl font-bold text-neutral-900 dark:text-white mt-8 mb-4">Why We Built This</h2>
        <p>
