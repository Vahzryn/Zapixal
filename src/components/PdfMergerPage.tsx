          ...
          <div className="space-y-3">
                ...
                >
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    <button
                      ...
                      title="Move Up"
                      className="p-2 rounded-lg text-neutral-500 hover:bg-neutral-200 dark:hover:bg-neutral-700 disabled:opacity-30 disabled:hover:bg-transparent transition-colors"
                    >
                    ...
                    <button
                      ...
                      title="Remove File"
                      className="p-2 rounded-lg text-red-500 hover:bg-red-50 dark:hover:bg-red-950/50 transition-colors ml-2"
                    >
            ...
            <div className="pt-4 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-2 text-xs text-neutral-500 dark:text-neutral-400">
                ...
                <span>100% Private — Processed locally in browser memory</span>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-emerald-700 dark:text-emerald-400">
                    Combined size: {formatBytes(successResult.size)}
                  </p>
                </div>
              </div>
