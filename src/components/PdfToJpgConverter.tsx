        ...
        <div className="flex flex-col gap-6">
          ...
          {processedResults.length > 0 && !isProcessing && (
            <div className="flex flex-col gap-6 mt-2 animate-in fade-in zoom-in-98 duration-300">
              ...
              <div className="bg-white dark:bg-[#1e2024] rounded-3xl border border-neutral-200/80 dark:border-neutral-800 p-6 sm:p-8 flex flex-col items-center text-center gap-5 shadow-lg">
                ...
                <div className="w-full max-w-md space-y-3 pt-1">
                  {processedResults.length > 1 ? (
                    <button
                      ...
                      disabled={isZipping}
                      className="w-full flex items-center justify-center gap-2.5 py-3.5 px-6 text-sm sm:text-base font-bold text-white bg-blue-600 hover:bg-blue-700 active:scale-[0.99] rounded-2xl shadow-lg shadow-blue-600/25 transition-all cursor-pointer disabled:opacity-80"
                  ...
                  <div className="flex items-center justify-center gap-4 text-xs">
                    <button
                      onClick={handleReset}
                      className="inline-flex items-center gap-1.5 font-semibold text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-200 transition-colors cursor-pointer"
                    >
                      <RefreshCw className="w-3.5 h-3.5" />
                      <span>Choose Another PDF</span>
                    </button>
