...
export function TextDiffPage({ seoData, onNavigate }: TextDiffPageProps) {
  ...
  return (
    <div className="w-full space-y-6 animate-in fade-in duration-300">
      {/* Header Banner */}
      <div className="bg-white dark:bg-neutral-800/90 border border-neutral-200 dark:border-neutral-700/80 rounded-2xl p-4 sm:p-5 shadow-xs relative overflow-hidden">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-1">
            <h1 className="text-xl sm:text-2xl font-bold text-neutral-900 dark:text-white tracking-tight flex items-center gap-2">
              <GitCompare className="w-5 h-5 text-emerald-600 dark:text-emerald-400 shrink-0" />
              <span>Diff Viewer &amp; Text Comparator</span>
            </h1>
            <p className="text-xs sm:text-sm text-neutral-600 dark:text-neutral-300 max-w-2xl leading-relaxed">
              Compare source code, JSON, logs, or plain text documents with character-level change highlighting, whitespace controls, and instant patch export.
            </p>
          </div>
