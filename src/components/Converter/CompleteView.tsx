          ...
          {hasDirectoryPicker && onDownloadToDirectory && successCount > 1 && (
            <div className="flex flex-col items-center gap-1.5 flex-1 sm:flex-initial">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 sm:px-6 py-3.5 sm:py-4 text-sm sm:text-base font-bold text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/40 hover:bg-emerald-100 dark:hover:bg-emerald-900/50 border border-emerald-200 dark:border-emerald-800 rounded-2xl shadow-sm active:scale-95 transition-all cursor-pointer"
              ...
              <span className="text-[10px] text-neutral-500 dark:text-[#9aa0a6] text-center max-w-[200px] leading-snug">
                To stream files directly to your device without ZIP overhead, use Save to Folder.
              </span>
            </div>
          )}
