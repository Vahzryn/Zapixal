...
export const MarkdownLivePreviewPage: React.FC<MarkdownLivePreviewPageProps> = ({
  ...
  return (
    <div className="w-full py-2 sm:py-4 px-2 sm:px-4 max-w-7xl mx-auto flex flex-col gap-6">
      {/* Action Toolbar */}
      <header className="flex flex-wrap items-center justify-between gap-3 p-3 sm:p-4 bg-white dark:bg-[#1e1f20] border border-neutral-200/80 dark:border-neutral-800 rounded-2xl">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className="px-3 py-1.5 rounded-lg border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-800 text-neutral-800 dark:text-neutral-200 text-xs font-medium hover:bg-neutral-50 dark:hover:bg-neutral-700 transition flex items-center gap-1.5 cursor-pointer shadow-xs"
          >
