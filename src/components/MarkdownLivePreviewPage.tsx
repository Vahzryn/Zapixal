...
export const MarkdownLivePreviewPage: React.FC<MarkdownLivePreviewPageProps> = ({
  ...
  return (
    <div className="w-full min-h-screen py-4 sm:py-8 px-3 sm:px-6 max-w-7xl mx-auto flex flex-col gap-6">
      {/* Header Banner */}
      <header className="flex flex-col gap-2">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              className="px-3 py-1.5 rounded-lg border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-800 text-neutral-800 dark:text-neutral-200 text-xs sm:text-sm font-medium hover:bg-neutral-50 dark:hover:bg-neutral-700 transition flex items-center gap-1.5 cursor-pointer shadow-xs"
            >
        ...
        <p className="text-xs sm:text-sm text-neutral-600 dark:text-neutral-400 max-w-4xl leading-relaxed">
          Write and preview GitHub-Flavored Markdown (GFM) in real-time. Includes table alignments, task lists, code fences, strict sanitization, live statistics, and instant HTML export.
        </p>
      </header>

      {/* Syntax Cheat Sheet Drawer if open */}
      {showCheatSheet && (
        <section className="p-4 sm:p-6 rounded-3xl border border-blue-200 dark:border-blue-800 bg-blue-50/50 dark:bg-blue-950/20 shadow-sm animate-in fade-in duration-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 text-xs">
            <div className="p-3 bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800">
              <span className="font-bold text-neutral-900 dark:text-white block mb-1">Headings & Rules</span>
            ...
            <div className="p-3 bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800">
              <span className="font-bold text-neutral-900 dark:text-white block mb-1">Emphasis & Inline</span>
            ...
            <div className="p-3 bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800">
              <span className="font-bold text-neutral-900 dark:text-white block mb-1">Lists & Tasks</span>
            ...
            <div className="p-3 bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800">
              <span className="font-bold text-neutral-900 dark:text-white block mb-1">Links & Images</span>
            ...
            <div className="p-3 bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800">
              <span className="font-bold text-neutral-900 dark:text-white block mb-1">Blockquotes & Code</span>
            ...
            <div className="p-3 bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800">
              <span className="font-bold text-neutral-900 dark:text-white block mb-1">GFM Tables</span>
      ...
      <section className="bg-white dark:bg-neutral-900 rounded-3xl border border-neutral-200 dark:border-neutral-800 shadow-sm p-3 sm:p-4 flex flex-col gap-3">
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 border-b border-neutral-100 dark:border-neutral-800 pb-3">
          ...
          <div className="flex flex-wrap items-center gap-1">
            <button
              ...
              title="Heading 1 (#)"
              className="p-1.5 rounded-lg text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition"
            >
          ...
          {/* View Mode Switcher */}
          <div className="flex items-center bg-neutral-100 dark:bg-neutral-800 rounded-xl p-1 text-xs">
            <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-stretch min-h-[560px]">
          ...
          {(viewMode === 'split' || viewMode === 'editor') && (
            <div
              className={`flex flex-col rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-neutral-50/50 dark:bg-neutral-950/40 p-3 sm:p-4 ${
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <button
                    ...
                    className="px-2 py-1 rounded-lg text-xs font-medium text-neutral-700 dark:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-800 transition flex items-center gap-1"
                  >
              ...
              <div className="flex-1 relative min-h-[480px]">
                <textarea
                  ...
                  spellCheck="false"
                  className="w-full h-full min-h-[480px] p-4 rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100 font-mono text-xs sm:text-sm leading-relaxed resize-y focus:outline-hidden focus:ring-2 focus:ring-blue-500 shadow-inner"
                />
              </div>

              {/* Character / Word count footer */}
              <div className="mt-2 pt-2 border-t border-neutral-200 dark:border-neutral-800 flex flex-wrap items-center justify-between text-xs text-neutral-500 dark:text-neutral-400 gap-2">
          ...
          {(viewMode === 'split' || viewMode === 'preview') && (
            ...
            >
              ...
              <div className="flex flex-wrap items-center justify-between mb-2 gap-2">
                <div className="flex items-center bg-neutral-200/70 dark:bg-neutral-800/80 rounded-xl p-1 text-xs">
                  <button
                ...
                <div className="flex items-center gap-1.5">
                  {activeTab === 'preview' && (
                    <button
                      ...
                      className="px-2.5 py-1 rounded-lg text-xs font-medium bg-blue-600 text-white hover:bg-blue-700 transition flex items-center gap-1 shadow-xs"
                    >
                      <Download className="w-3.5 h-3.5" />
                      Export HTML
                    </button>
                  ...
                  {activeTab === 'html-source' && (
                    <button
                      ...
                      className="px-2.5 py-1 rounded-lg text-xs font-medium text-neutral-700 dark:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-800 transition flex items-center gap-1"
                    >
              ...
              {/* Tab Contents */}
              <div className="flex-1 min-h-[480px] bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 p-4 overflow-y-auto max-h-[700px] shadow-inner">
                ...
                {activeTab === 'preview' && (
                  <div ref={previewRef} className="markdown-preview-root w-full">
                    {renderedHtml ? (
                      ...
                      <div className="flex flex-col items-center justify-center min-h-[300px] text-neutral-400 text-center">
                ...
                {activeTab === 'html-source' && (
                  <pre className="font-mono text-xs sm:text-sm text-neutral-800 dark:text-neutral-200 whitespace-pre-wrap break-all leading-relaxed">
                ...
                {activeTab === 'plain-text' && (
                  <div className="font-sans text-xs sm:text-sm text-neutral-800 dark:text-neutral-200 whitespace-pre-wrap leading-relaxed">
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                      <div className="p-3 bg-neutral-50 dark:bg-neutral-800/60 rounded-xl border border-neutral-200 dark:border-neutral-700">
                        <span className="text-[11px] text-neutral-500 dark:text-neutral-400 uppercase font-bold block">
                          Word Count
                        </span>
                    ...
                    <div className="p-4 bg-neutral-50 dark:bg-neutral-800/40 rounded-2xl border border-neutral-200 dark:border-neutral-700">
                      <h4 className="text-xs font-bold uppercase tracking-wider text-neutral-700 dark:text-neutral-300 mb-3 flex items-center gap-2">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-xs">
                        <div className="flex justify-between py-1 border-b border-neutral-200 dark:border-neutral-700">
                          ...
                          <span className="font-bold text-neutral-900 dark:text-white">{stats.lineCount}</span>
                        </div>
                        <div className="flex justify-between py-1 border-b border-neutral-200 dark:border-neutral-700">
                          <span className="text-neutral-500">Paragraphs</span>
                          <span className="font-bold text-neutral-900 dark:text-white">{stats.paragraphCount}</span>
                        </div>
                        <div className="flex justify-between py-1 border-b border-neutral-200 dark:border-neutral-700">
                          <span className="text-neutral-500">Headings</span>
                          <span className="font-bold text-neutral-900 dark:text-white">{stats.headingCount}</span>
                        </div>
                        <div className="flex justify-between py-1 border-b border-neutral-200 dark:border-neutral-700">
                          <span className="text-neutral-500">Links</span>
                          <span className="font-bold text-neutral-900 dark:text-white">{stats.linkCount}</span>
                        </div>
                        <div className="flex justify-between py-1 border-b border-neutral-200 dark:border-neutral-700">
                          <span className="text-neutral-500">Images</span>
                          <span className="font-bold text-neutral-900 dark:text-white">{stats.imageCount}</span>
                        </div>
                        <div className="flex justify-between py-1 border-b border-neutral-200 dark:border-neutral-700">
                          <span className="text-neutral-500">Code Blocks</span>
                          <span className="font-bold text-neutral-900 dark:text-white">{stats.codeBlockCount}</span>
                        </div>
                      </div>
                    </div>
              ...
              <div className="mt-2 pt-2 border-t border-neutral-200 dark:border-neutral-800 flex items-center justify-between text-xs text-neutral-500 dark:text-neutral-400">
      ...
      {showPresetsModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-xs animate-in fade-in">
          <div className="bg-white dark:bg-neutral-900 rounded-3xl border border-neutral-200 dark:border-neutral-800 max-w-xl w-full p-5 sm:p-6 shadow-xl flex flex-col gap-4">
              ...
              {MARKDOWN_PRESETS.map((preset) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[10px] px-2 py-0.5 rounded-full bg-neutral-200 dark:bg-neutral-700 text-neutral-700 dark:text-neutral-300 uppercase font-semibold">
                      {preset.category}
                    </span>
                  </div>
