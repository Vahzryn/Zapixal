...
function GlobalControlsComponent({
  ...
  return (
    <div className="flex flex-col gap-3 sm:gap-4 bg-white dark:bg-neutral-900 p-4 sm:p-5 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-xs w-full relative z-30">
      
      {/* Segmented Mode Switcher */}
      <div className="flex w-full bg-neutral-100 dark:bg-neutral-800/80 p-1 rounded-xl">
        <button
          type="button"
            ...
            <div className="flex flex-col gap-1 w-full sm:w-auto">
              ...
              <div className="relative inline-block min-w-[150px] w-full sm:w-auto">
                <select
                  ...
                  className="w-full appearance-none bg-neutral-50 hover:bg-neutral-100 dark:bg-neutral-800 dark:hover:bg-neutral-700/80 border border-neutral-200 dark:border-neutral-700 text-neutral-900 dark:text-white text-xs sm:text-sm font-medium rounded-lg px-3 py-2 pr-8 cursor-pointer focus:outline-none transition-colors"
                ...
                <div className="flex flex-col gap-1 flex-1 w-full">
                  ...
                  <div className="flex items-center gap-2 w-full">
                    <input
                      ...
                      className="w-full sm:w-28 bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 text-neutral-900 dark:text-white text-sm font-medium rounded-lg px-3 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500"
                    />
                    <span className="text-xs font-semibold text-neutral-500">KB</span>
                  </div>
                </div>
              ) : (
                (localQuality <= 0.95) && (
          ...
          <div className="hidden md:block shrink-0 w-full lg:w-auto">
            {isProcessing ? (
              ...
              <button
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2 px-7 py-2.5 text-sm font-semibold text-white bg-blue-600 hover:bg-blue-700 disabled:bg-neutral-300 dark:disabled:bg-neutral-800 disabled:text-neutral-500 rounded-xl transition-colors cursor-pointer disabled:cursor-not-allowed shadow-xs"
              >
      ...
      {primaryRenderers.length > 0 && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 pt-3 border-t border-neutral-100 dark:border-neutral-800">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5 pt-2.5 border-t border-neutral-100 dark:border-neutral-800 w-full">
          ...
          {!isLockedFormat && !isCompress && (
            <>
              <button
                ...
                className="px-2.5 py-1 text-xs font-medium text-neutral-600 dark:text-neutral-300 bg-neutral-100 hover:bg-neutral-200/70 dark:bg-neutral-800 dark:hover:bg-neutral-700 rounded-md transition-colors cursor-pointer disabled:opacity-50"
              >
                WebP Standard
              </button>
              <button
        ...
        {secondaryRenderers.length > 0 && (
          <button
            ...
            className="flex items-center justify-center gap-1.5 cursor-pointer w-full sm:w-auto px-3 py-1 text-xs font-medium text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white transition-colors"
