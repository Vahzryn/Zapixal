...
function GlobalControlsComponent({
  ...
  const renderResizeControls = () => (
    <div className="flex flex-col gap-2.5 p-3 sm:p-4 bg-white dark:bg-[#202124] border border-emerald-100 dark:border-[#2d523c] rounded-xl">
      <div className="flex items-center justify-between mb-0.5">
        <div className="flex items-center gap-1.5">
          <div className="p-1 bg-emerald-100 dark:bg-[#1e3427] text-emerald-600 dark:text-[#81c995] rounded-lg">
            <Maximize className="w-3.5 h-3.5" />
          </div>
          <h4 className="text-xs sm:text-sm font-bold text-neutral-800 dark:text-[#e8eaed]">Dimension Resizing</h4>
        </div>
      ...
      {settings.resize.enabled && (
        <div className="grid grid-cols-2 gap-2 sm:gap-3 animate-in fade-in slide-in-from-top-1">
          <div>
            <label className="block mb-1 text-[10px] sm:text-xs font-bold text-neutral-600 dark:text-[#9aa0a6]">Max Width (px)</label>
            <input
              type="number"
              ...
              disabled={disabled}
              className="w-full px-2 py-1 sm:px-3 sm:py-1.5 text-xs font-semibold border-2 rounded-lg sm:rounded-xl bg-neutral-50 dark:bg-[#303134] border-neutral-200 dark:border-[#3c4043] text-neutral-800 dark:text-[#e8eaed] focus:border-emerald-500 focus:outline-none transition-colors shadow-2xs"
            />
          </div>
          <div>
            <label className="block mb-1 text-[10px] sm:text-xs font-bold text-neutral-600 dark:text-[#9aa0a6]">Max Height (px)</label>
            <input
              type="number"
          ...
          <label className="flex items-center gap-1.5 cursor-pointer mt-0.5 col-span-2">
            ...
            />
            <span className="text-[11px] sm:text-xs font-semibold text-neutral-700 dark:text-[#e8eaed]">Keep aspect ratio</span>
          </label>
        </div>
      )}
    </div>
  ...
  const renderCropControls = () => (
    <div className="flex flex-col gap-2.5 p-3 sm:p-4 bg-white dark:bg-[#202124] border border-indigo-100 dark:border-[#282d4a] rounded-xl">
      <div className="flex items-center justify-between mb-0.5">
        <div className="flex items-center gap-1.5">
          <div className="p-1 bg-indigo-100 dark:bg-[#1e2338] text-indigo-600 dark:text-[#a8b1ff] rounded-lg">
            <Crop className="w-3.5 h-3.5" />
          </div>
          <h4 className="text-xs sm:text-sm font-bold text-neutral-800 dark:text-[#e8eaed]">Crop Aspect Ratio</h4>
        </div>
        {settings.cropAspectRatio && (
          <button
            ...
            disabled={disabled}
            className="text-[10px] sm:text-[11px] font-bold text-indigo-600 dark:text-[#a8b1ff] hover:underline cursor-pointer"
          >
            Clear Crop
          </button>
        )}
      ...
      <div className="pt-2 border-t border-neutral-100 dark:border-[#3c4043]">
        <label className="block mb-1 text-[10px] sm:text-xs font-bold text-neutral-600 dark:text-[#9aa0a6]">
          Custom Ratio (W : H)
        </label>
        <div className="flex items-center gap-1.5">
          <input
            ...
            className="w-16 sm:w-20 px-2 py-1 sm:px-3 sm:py-1.5 text-xs font-semibold border-2 rounded-lg sm:rounded-xl bg-neutral-50 dark:bg-[#303134] border-neutral-200 dark:border-[#3c4043] text-neutral-800 dark:text-[#e8eaed] focus:border-indigo-500 focus:outline-none transition-colors"
          />
  ...
  const renderDpiControls = () => (
    <div className="flex flex-col gap-2.5 p-3 sm:p-4 bg-white dark:bg-[#202124] border border-blue-100 dark:border-[#2d3a4e] rounded-xl">
      <div className="flex items-center justify-between mb-0.5">
        <div className="flex items-center gap-1.5">
          <div className="p-1 bg-blue-100 dark:bg-[#1e293b] text-blue-600 dark:text-[#8ab4f8] rounded-lg">
            <Printer className="w-3.5 h-3.5" />
          </div>
          <h4 className="text-xs sm:text-sm font-bold text-neutral-800 dark:text-[#e8eaed]">Target DPI</h4>
        </div>
        {settings.targetDPI !== null && settings.targetDPI !== undefined && (
          <button
            ...
            className="text-[10px] sm:text-[11px] font-bold text-blue-600 dark:text-[#8ab4f8] hover:underline cursor-pointer"
          >
            Clear DPI
          </button>
        )}
      ...
      <div className="pt-2 border-t border-neutral-100 dark:border-[#3c4043] flex items-center justify-between">
        <label className="text-[11px] sm:text-xs font-bold text-neutral-600 dark:text-[#9aa0a6]">
          Custom DPI
        </label>
        <div className="flex items-center gap-2">
          <input
            ...
            className="w-20 sm:w-24 px-2 py-1 sm:px-3 sm:py-1.5 text-xs font-semibold border-2 rounded-lg sm:rounded-xl bg-neutral-50 dark:bg-[#303134] border-neutral-200 dark:border-[#3c4043] text-neutral-800 dark:text-[#e8eaed] focus:border-blue-500 focus:outline-none transition-colors"
          />
        </div>
      </div>
    </div>
  ...
  const renderRotationControls = () => (
    <div className="flex flex-col gap-2.5 p-3 sm:p-4 bg-white dark:bg-[#202124] border border-amber-100 dark:border-[#3a2818] rounded-xl">
      <div className="flex items-center justify-between mb-0.5">
        <div className="flex items-center gap-1.5">
          <div className="p-1 bg-amber-100 dark:bg-[#3a2818] text-amber-600 dark:text-[#fdd663] rounded-lg">
            <RotateCw className="w-3.5 h-3.5" />
          </div>
          <h4 className="text-xs sm:text-sm font-bold text-neutral-800 dark:text-[#e8eaed]">Batch Rotation</h4>
        </div>
      </div>
  ...
  const renderPrivacyControls = () => (
    <div className="flex flex-col gap-2.5 p-3 sm:p-4 bg-white dark:bg-[#202124] border border-rose-100 dark:border-[#381e26] rounded-xl">
      <div className="flex items-center justify-between mb-0.5">
        <div className="flex items-center gap-1.5">
          <div className="p-1 bg-rose-100 dark:bg-[#381e26] text-rose-600 dark:text-[#f28b82] rounded-lg">
            <ShieldCheck className="w-3.5 h-3.5" />
          </div>
          <h4 className="text-xs sm:text-sm font-bold text-neutral-800 dark:text-[#e8eaed]">Metadata & Privacy</h4>
        </div>
      </div>
      
      <label className="flex items-start gap-2.5 p-2.5 bg-neutral-50 dark:bg-[#303134] border border-neutral-200 dark:border-[#3c4043] rounded-xl cursor-pointer hover:border-rose-300 dark:hover:border-rose-800 transition-colors">
        <input
          type="checkbox"
          checked={settings.stripExif !== false}
          onChange={(e) => updateSettings({ stripExif: e.target.checked })}
          disabled={disabled}
          className="mt-0.5 w-3.5 h-3.5 text-rose-500 rounded border-neutral-300 dark:border-[#5f6368] dark:bg-[#202124] focus:ring-rose-500 cursor-pointer"
        />
        <div>
          <span className="block text-[11px] sm:text-xs font-bold text-neutral-800 dark:text-[#e8eaed]">
            Strip EXIF & Location Data
          </span>
          <span className="block text-[10px] text-neutral-500 dark:text-[#9aa0a6] mt-0.5 leading-normal">
  ...
  return (
    <div className="flex flex-col gap-2.5 min-[360px]:gap-3 sm:gap-4 bg-white dark:bg-[#303134] p-2.5 min-[360px]:p-3 sm:p-5 rounded-xl sm:rounded-3xl border border-neutral-200 dark:border-[#3c4043] shadow-xs w-full relative z-30 min-h-[100px]">
      
      {/* Segmented Mode Switcher */}
      <div className="flex w-full bg-neutral-100 dark:bg-neutral-800 p-1 rounded-xl sm:rounded-2xl border border-neutral-200/60 dark:border-[#3c4043] shadow-inner mb-1 sm:mb-2.5">
        <button
          type="button"
          onClick={() => handleModeChange('convert')}
          className={cn(
            "flex-1 flex items-center justify-center gap-1.5 py-1.5 min-[360px]:py-2 sm:py-2.5 text-[11px] min-[360px]:text-xs sm:text-sm font-black rounded-lg sm:rounded-xl transition-all cursor-pointer",
            mode === 'convert'
              ? "bg-white dark:bg-[#202124] text-blue-600 dark:text-[#8ab4f8] shadow-xs"
              : "text-neutral-500 dark:text-[#9aa0a6] hover:text-neutral-800 dark:hover:text-[#e8eaed]"
          )}
        >
        ...
        <button
          ...
          className={cn(
            "flex-1 flex items-center justify-center gap-1.5 py-1.5 min-[360px]:py-2 sm:py-2.5 text-[11px] min-[360px]:text-xs sm:text-sm font-black rounded-lg sm:rounded-xl transition-all cursor-pointer",
            mode === 'compress'
              ? "bg-white dark:bg-[#202124] text-emerald-600 dark:text-emerald-400 shadow-xs"
              : "text-neutral-500 dark:text-[#9aa0a6] hover:text-neutral-800 dark:hover:text-[#e8eaed]"
          )}
        >
      ...
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-2.5 min-[360px]:gap-3 sm:gap-4 lg:gap-4 w-full">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-4 w-full lg:w-auto flex-1">
          ...
          {mode === 'compress' ? (
                  ...
                  <div className="flex flex-col gap-1 flex-1 w-full">
                    ...
                    <div className="flex items-center gap-1.5 w-full">
                      <input
                        ...
                        className="w-full sm:w-32 bg-white dark:bg-[#202124] border-2 border-emerald-200 dark:border-[#2d523c] text-neutral-800 dark:text-[#e8eaed] text-[11px] min-[360px]:text-xs sm:text-base font-bold rounded-lg sm:rounded-xl px-2.5 py-1.5 min-[360px]:px-3 min-[360px]:py-2 sm:px-4 sm:py-3 focus:outline-none focus:ring-4 focus:ring-emerald-500/20 transition-all shadow-xs"
                      />
                      <span className="text-xs sm:text-sm font-bold text-neutral-500 dark:text-[#9aa0a6]">KB</span>
                    </div>
                  </div>
                ) : (
                  (localQuality <= 0.95) && (
                    <div className="flex flex-col gap-1 flex-1 w-full">
                      <label className="text-[10px] sm:text-xs font-black text-neutral-500 dark:text-[#9aa0a6] uppercase tracking-wider whitespace-nowrap">
                        Quality Level: {Math.round(localQuality * 100)}%
                      </label>
                      <div className="flex items-center h-[40px] sm:h-[52px] w-full">
                        <input
                          type="range"
                          min="0.1"
                          max="1"
                          ...
                          className="w-full h-2 bg-neutral-200 dark:bg-[#3c4043] rounded-lg appearance-none cursor-pointer accent-emerald-500"
                        />
                      </div>
                    </div>
                  )
            ...
            <div className="flex flex-col gap-1 sm:gap-1.5 flex-1 min-w-[150px] w-full sm:w-auto mt-1 sm:mt-0">
              <label className="text-[10px] sm:text-xs font-black text-neutral-500 dark:text-[#9aa0a6] uppercase tracking-wider whitespace-nowrap">
              ...
              <div className="flex items-center h-[40px] sm:h-[52px] w-full">
                <input
                  ...
                  onMouseUp={(e) => handleQualityCommit(parseFloat((e.target as HTMLInputElement).value))}
                  onTouchEnd={(e) => handleQualityCommit(parseFloat((e.target as HTMLInputElement).value))}
                  className="w-full h-2 bg-neutral-200 dark:bg-[#3c4043] rounded-lg appearance-none cursor-pointer accent-blue-600"
                />
              </div>
            </div>
          )}
          ...
          <div className="hidden md:block w-full lg:w-auto flex-shrink-0 mt-4 lg:mt-0">
            {isProcessing ? (
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
                <div className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3.5 text-base sm:text-lg font-black text-emerald-700 bg-emerald-50 dark:bg-emerald-900/30 dark:text-emerald-400 rounded-xl border-b-4 border-emerald-100 dark:border-emerald-900/50 cursor-default">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 pt-3 border-t border-neutral-100 dark:border-[#3c4043] w-full">
        <div className="flex flex-wrap items-center gap-1.5 w-full sm:w-auto">
          {!isLockedFormat && !isCompress && (
            <>
              <span className="text-[10px] font-bold text-neutral-400 dark:text-[#9aa0a6] uppercase tracking-wider mr-1 hidden xl:inline-block">Presets:</span>
              <button
                disabled={disabled}
                onClick={() => onChange({ ...settings, targetFormat: 'webp', quality: 0.8, targetMaxKB: undefined })}
                className="flex items-center gap-1.5 px-2.5 py-1.5 text-[11px] font-bold text-blue-700 bg-blue-50 border border-blue-200 rounded-lg hover:bg-blue-100 transition-colors disabled:opacity-50 dark:bg-[#1e293b] dark:text-[#8ab4f8] dark:border-[#2d3a4e] cursor-pointer"
              >
                <Globe className="w-3 h-3" /> Web Optimized
              </button>
              <button
                disabled={disabled}
                onClick={() => onChange({ ...settings, targetFormat: 'jpg', quality: 0.85, targetMaxKB: undefined })}
                className="flex items-center gap-1.5 px-2.5 py-1.5 text-[11px] font-bold text-purple-700 bg-purple-50 border border-purple-200 rounded-lg hover:bg-purple-100 transition-colors disabled:opacity-50 dark:bg-[#2e1d40] dark:text-[#c58af9] dark:border-[#432a5a] cursor-pointer"
              >
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-2.5 py-1.5 text-[11px] font-bold text-emerald-700 bg-emerald-50 border border-emerald-200 rounded-lg hover:bg-emerald-100 transition-colors disabled:opacity-50 dark:bg-[#1e3427] dark:text-[#81c995] dark:border-[#2d523c] cursor-pointer"
              >
                <Minimize2 className="w-3 h-3" /> Max Compression
              </button>
            </>
          )}
        </div>
        ...
        {secondaryRenderers.length > 0 && (
          <button
            ...
            className="flex items-center justify-center gap-1.5 cursor-pointer w-full sm:w-auto px-3 py-1.5 bg-neutral-50 hover:bg-neutral-100 dark:bg-[#202124] dark:hover:bg-[#292a2d] transition-colors rounded-lg border border-neutral-200 dark:border-[#3c4043]"
            aria-expanded={showAdvanced}
          >
            <Settings2 className="w-3.5 h-3.5 text-neutral-600 dark:text-[#9aa0a6]" />
            <span className="text-[11px] sm:text-xs font-bold text-neutral-700 dark:text-[#e8eaed]">
