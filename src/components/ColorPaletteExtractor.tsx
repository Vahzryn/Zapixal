        ...
        {!file && (
          ...
          >
            ...
            <div className="p-4 bg-white dark:bg-neutral-800 border border-neutral-100 dark:border-neutral-700 rounded-2xl shadow-sm mb-4">
              <Palette className="w-8 h-8 text-neutral-400 dark:text-neutral-500 animate-pulse" />
            </div>
            <h3 className="text-base sm:text-lg font-bold text-neutral-800 dark:text-white mb-1">
              Drag & Drop Image for Palette Extraction
            </h3>
            <p className="text-xs sm:text-sm text-neutral-500 dark:text-[#9aa0a6] max-w-sm mb-4">
        ...
        {file && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mt-2">
            ...
            <div className="lg:col-span-6 xl:col-span-7 flex flex-col gap-4">
              <div className="border border-neutral-150 dark:border-neutral-800/80 bg-neutral-50/20 dark:bg-neutral-800/10 p-4 rounded-3xl flex flex-col gap-3">
                <div className="flex items-center justify-between gap-3 border-b border-neutral-100 dark:border-neutral-800 pb-2">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-xs font-bold text-neutral-700 dark:text-[#e8eaed]">
                ...
                {previewUrl && (
                  <div className="relative w-full rounded-2xl border border-neutral-200 dark:border-neutral-800 overflow-hidden bg-neutral-100 dark:bg-neutral-900 flex items-center justify-center select-none group min-h-[250px]">
                    <img
                      ref={imageRef}
                      src={previewUrl}
                ...
                <div className="flex items-center justify-between flex-wrap gap-2 text-xs text-neutral-500 pt-1">
                  <span>Coordinates: Hover image viewport</span>
                  {hoverColor && (
                    <div className="flex items-center gap-1.5">
                      <span className="font-semibold text-neutral-800 dark:text-white">Sampled Color:</span>
                      <div className="w-4 h-4 rounded-md border border-neutral-200/60" style={{ backgroundColor: hoverColor }} />
                      <span className="font-mono font-bold text-neutral-700 dark:text-[#a8b1ff]">{hoverColor}</span>
                    </div>
                  )}
                </div>
              </div>
            ...
            <div className="lg:col-span-6 xl:col-span-5 flex flex-col gap-5">
              ...
              <div className="border border-neutral-200/80 dark:border-neutral-800 rounded-3xl p-4 sm:p-5 flex flex-col gap-4 bg-neutral-50/10">
                <div className="flex items-center gap-2 border-b border-neutral-100 dark:border-neutral-800 pb-2.5">
                  <Palette className="w-4 h-4 text-indigo-500" />
                  <h3 className="text-sm font-bold text-neutral-800 dark:text-white">Extracted Representative Palette</h3>
                </div>

                {loading ? (
                  <div className="flex items-center gap-2.5 text-xs text-neutral-400 italic py-6">
                    ...
                    {extractedPalette.map((hex, index) => {
                      ...
                      return (
                        <button
                          ...
                          className="flex items-center justify-between p-2 rounded-2xl border border-neutral-150 dark:border-neutral-800 hover:border-neutral-300 dark:hover:border-neutral-700 hover:scale-[1.02] active:scale-[0.98] text-left transition-all cursor-pointer group"
                        >
                          <div className="flex items-center gap-2">
                            <div
                              className="w-8 h-8 rounded-xl border border-neutral-200/60 flex items-center justify-center shrink-0"
                              style={{ backgroundColor: hex }}
                            />
                            <div className="flex flex-col">
                              <span className="font-mono text-xs font-bold text-neutral-800 dark:text-[#e8eaed]">{hex}</span>
                              <span className="text-[10px] text-neutral-400 capitalize">Swatch {index + 1}</span>
                            </div>
                          </div>
                          
                          <div className="text-neutral-300 dark:text-neutral-600 group-hover:text-indigo-500 transition-colors p-1">
                            {copiedColor === hex ? (
              ...
              <div className="border border-neutral-200/80 dark:border-neutral-800 rounded-3xl p-4 sm:p-5 flex flex-col gap-4 bg-neutral-50/10">
                <div className="flex items-center justify-between gap-3 border-b border-neutral-100 dark:border-neutral-800 pb-2.5">
                  <div className="flex items-center gap-2">
                    <Pipette className="w-4 h-4 text-emerald-500" />
                    <h3 className="text-sm font-bold text-neutral-800 dark:text-white">Custom Clicked Colors</h3>
                  </div>
                  {customColors.length > 0 && (
                    <button
                      onClick={() => setCustomColors([])}
                      className="text-[10px] font-semibold text-neutral-400 hover:text-red-500 transition-colors cursor-pointer"
                    >
                      Clear custom
                    </button>
                  )}
                ...
                {customColors.length === 0 ? (
                  <div className="text-center py-6 border border-dashed border-neutral-150 dark:border-neutral-800 rounded-2xl">
                  ...
                  <div className="flex flex-wrap gap-2.5">
                    {customColors.map((hex, index) => (
                      <button
                        ...
                        onClick={() => copyColorToClipboard(hex)}
                        className="flex items-center gap-1.5 px-3 py-2 rounded-xl border border-neutral-150 dark:border-neutral-800 hover:border-indigo-300 transition-all cursor-pointer group hover:scale-[1.03]"
                      >
                        <div className="w-4 h-4 rounded-md border border-neutral-200/40 shrink-0" style={{ backgroundColor: hex }} />
                        <span className="font-mono text-xs font-bold text-neutral-700 dark:text-[#a8b1ff]">{hex}</span>
                        {copiedColor === hex ? (
                          <Check className="w-3 h-3 text-green-500" />
                        ) : (
                          <Copy className="w-3.5 h-3.5 text-neutral-300 dark:text-neutral-600 group-hover:text-indigo-400 transition-colors" />
                        )}
                      </button>
                    ))}
                  </div>
              ...
              <button
                onClick={handleReset}
                className="w-full flex items-center justify-center gap-2 py-3 bg-neutral-100 hover:bg-neutral-200 dark:bg-neutral-800 dark:hover:bg-neutral-700 text-neutral-700 dark:text-white text-xs font-bold rounded-2xl transition-all"
              >
