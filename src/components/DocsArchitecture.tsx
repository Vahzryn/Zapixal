      ...
      <div className="space-y-12">
        <section>
          ...
          <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed mb-4">
            We utilize high-performance WASM binaries and Web Workers for complex image decoding and encoding. Our engine runs <code>@jsquash/jpeg</code> (mozjpeg) for optimal JPEG encoding, <code>imagequant</code> for advanced PNG quantization (with <code>upng-js</code> as a fallback), and <code>heic2any</code> inside a dedicated Web Worker to safely decode Apple's HEIC format. This allows us to achieve near-native encoding speeds entirely within the browser's sandbox.
          </p>
