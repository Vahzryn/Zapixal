  ...
  return (
    <div className="w-full flex flex-col gap-6 animate-in fade-in duration-300 pb-12" id="jwt-decoder-root">
      ...
      <div className="space-y-2 border-b border-neutral-200 dark:border-neutral-800 pb-4">
        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-neutral-900 dark:text-white tracking-tight" id="jwt-decoder-title">
          {seoData.h1Title || 'JWT Debugger & Decoder'}
        </h1>
        <p className="text-xs sm:text-sm text-neutral-600 dark:text-neutral-400 max-w-3xl leading-relaxed">
          Decode, inspect, and verify JSON Web Tokens (JWT) locally in browser memory. View header algorithms, payload claims, expiration timers, and verify HMAC signatures.
        </p>
      </div>
