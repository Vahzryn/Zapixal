  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="pb-6 border-b border-slate-200/70 dark:border-[#222428] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="space-y-1.5">
            <div className="flex items-center gap-2">
              <img 
                ...
                className="w-7 h-7 rounded-lg object-contain bg-white dark:bg-[#1a1b1e] p-0.5 border border-slate-200/80 dark:border-[#32353a]"
              />
              <span className="text-lg font-bold text-slate-900 dark:text-white tracking-tight font-sans">
                Zapixal
              </span>
            </div>

            <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed max-w-lg font-sans">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 py-4 border-b border-slate-200/70 dark:border-[#222428]">
          ...
          <div className="space-y-2.5">
            ...
            <ul className="space-y-1.5 text-xs font-medium">
              <li>
                <a href="/tools" onClick={(e) => handleClick(e, '/tools')} className="font-semibold text-blue-600 dark:text-blue-400 hover:underline transition-colors">
                  All Tools Directory
                </a>
              </li>
              <li>
                <a href="/tools/images" onClick={(e) => handleClick(e, '/tools/images')} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  Image Tools
                </a>
              </li>
              <li>
                <a href="/tools/documents" onClick={(e) => handleClick(e, '/tools/documents')} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  PDF & Documents
                </a>
              </li>
              <li>
                <a href="/tools/developer" onClick={(e) => handleClick(e, '/tools/developer')} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  Developer Tools
                </a>
              </li>
              <li>
                <a href="/tools/text" onClick={(e) => handleClick(e, '/tools/text')} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  Text Tools
                </a>
              </li>
              <li>
                <a href="/tools/utilities" onClick={(e) => handleClick(e, '/tools/utilities')} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  Utilities & Design
                </a>
              </li>
            </ul>
          ...
          <div className="space-y-2.5">
            ...
            <ul className="space-y-1.5 text-xs font-medium">
              <li>
                <a href="/articles/benchmarks" onClick={(e) => handleClick(e, '/articles/benchmarks')} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors font-medium">
          ...
          <div className="space-y-2.5">
            ...
            <ul className="space-y-1.5 text-xs font-medium">
              ...
              <li>
                <a href="/merge-pdf" onClick={(e) => handleClick(e, '/merge-pdf')} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  Merge PDF
                </a>
              </li>
              <li>
                <a href="/json-formatter-validator" onClick={(e) => handleClick(e, '/json-formatter-validator')} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  JSON Formatter
                </a>
              </li>
              <li>
                <a href="/text-diff" onClick={(e) => handleClick(e, '/text-diff')} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  Text Diff
                </a>
              </li>
              <li>
                <a href="/markdown-live-preview" onClick={(e) => handleClick(e, '/markdown-live-preview')} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  Markdown Preview
                </a>
              </li>
              <li>
                <a href="/jwt-decoder" onClick={(e) => handleClick(e, '/jwt-decoder')} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  JWT Decoder
                </a>
              </li>
            </ul>
          ...
          <div className="space-y-2.5">
            ...
            <ul className="space-y-1.5 text-xs font-medium">
              <li>
                <a href="/widget" onClick={(e) => handleClick(e, '/widget')} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  Embed Widget API
                </a>
              </li>
              <li>
