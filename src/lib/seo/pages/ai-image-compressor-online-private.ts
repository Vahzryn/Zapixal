...
export function getPageSeo(fullUrl: string): SeoRouteData {
  ...
  return {
    ...
    metaDescription: 'Experience intelligent image compression without the privacy risks of the cloud. Content-aware local optimization for PNG, JPEG, and WebP. 100% Private.',
