...
export function getBulkHeicContent(): RouteEditorialContent {
  return {
    ...
    section2Body: 'Personal photos are among the most sensitive data we own. Uploading an entire library to a cloud converter creates a massive privacy risk. Zapixal eliminates this risk by keeping the entire conversion cycle local. Your HEIC files are decoded and re-encoded into JPEGs entirely within your browser’s RAM—nothing is ever uploaded or stored on our servers. Our converter also supports preserving original EXIF metadata, ensuring your timestamps and camera settings remain intact in the new JPEG files, giving you a seamless transition with zero privacy compromises.',
    steps: [
