...
export function getPageSeo(fullUrl: string): SeoRouteData {
  ...
  return {
    ...
    metaDescription: 'Extract the dominant, representative color palette from your images. Hover and click with the interactive eyedropper tool to copy custom pixel HEX codes securely offline.',
