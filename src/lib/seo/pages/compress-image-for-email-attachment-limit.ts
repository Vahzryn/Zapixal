...
export function getCompressEmailAttachmentContent(): RouteEditorialContent {
  return {
    ...
    section2Body: 'Shrinking a photo’s byte footprint for an email often compromises structural details like text lines, small icons, or signatures, making them difficult to read. Rather than relying on coarse auto-compression presets, Zapixal provides a real-time sliding quality metric that calculates output dimensions in local browser RAM prior to export. This allows you to find the perfect compromise between byte volume and visual integrity. Enjoy fluid adjustments and rapid local exports to prepare lightweight, business-ready email attachments.',
    steps: [
