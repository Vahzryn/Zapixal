...
export function getCompressTo200kbContent(): RouteEditorialContent {
  return {
    ...
    faqs: [
      ...
      makeFaq('How does Zapixal attempt the 200KB limit?', 'Our engine performs multiple "mini-encodes" in local memory to find the highest quality setting that results in a file size just below 200KB.'),
