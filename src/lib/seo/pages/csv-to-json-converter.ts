...
export function getPageSeo(fullUrl: string, path: string): SeoRouteData {
  ...
  return {
    ...
    metaTitle: 'CSV to JSON & JSON to CSV Converter — Fast, Private & Free',
    metaDescription: 'Convert CSV and TSV spreadsheets to JSON, or transform JSON arrays to RFC 4180 CSV tables. Features delimiter auto-detection, type inference, and interactive data grid view in local RAM.',
