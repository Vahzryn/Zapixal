...
export function getPageSeo(fullUrl: string, path: string): SeoRouteData {
  ...
  return {
    ...
    metaTitle: 'JWT Debugger & Decoder — Decode & Inspect Tokens Privately',
    metaDescription: 'Decode, inspect, and verify JSON Web Tokens (JWT) locally in browser memory. View header algorithms, payload claims, expiration timers, and verify HMAC signatures securely with zero server uploads.',
