...
export function getPageSeo(fullUrl: string, path: string): SeoRouteData {
  ...
  return {
    ...
    metaTitle: 'Markdown Live Previewer & Converter — GFM Editor & HTML Converter Online',
    metaDescription: 'Edit and preview GitHub-Flavored Markdown (GFM) in real-time with tables, task lists, code blocks, XSS sanitization, live statistics, and instant HTML export.',
